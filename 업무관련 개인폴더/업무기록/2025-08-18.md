...
- [ ] 2D top 메모리 할당 이슈
- [ ] Rear Side inspection 시 패키지 픽업 후 촬영할때 motor 오류 발생 (Jira 등록)
- [ ] [Manual Inspection] Auto focus tuning - Live 동작 안함
- [ ] [Manual Inspection] Auto focus tuning - JOG 동작 안함
- [ ] [Manual Inspection] Auto Calibration